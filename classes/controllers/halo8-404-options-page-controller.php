<?php
class Halo8404OptionsPageController extends Halo8AbstractOptionsPageController {
    ...
    public function setupSettingSection(){
        ...
        $sections[] = array('name' => 'halo8_'.$this->model->getPageName().'_404_slider_section', 'label' => sprintf(__('Slider for %s pages', $this->plugin_slug), $this->model->getPageName()));
        ...
        $fields[] = array('id' => '404_slider', 'label' => __('404 page slider', $this->plugin_slug), 'callback' => array($this, 'selectSlider'), 'section_name' => 'halo8_'.$this->model->getPageName().'_404_slider_section');
